...
func update(data: EnergySiteData):
	...
	match island_status.to_upper():
		"OFF_GRID_INTENTIONAL":
			visible = true
			get_material().set_shader_param("color", intentional_color)
		"OFF_GRID_UNINTENTIONAL", "OFF_GRID_UNINTENTIONAL_TRANSITIONING_ON_GRID", "OFF_GRID_UNINTENTIONAL_WAIT_FOR_SOLAR", "OFF_GRID_UNINTENTIONAL_WAIT_FOR_USER", "OFF_GRID_UNINTENTIONAL_WAIT_FOR_JUMP_START", "OFF_GRID_UNINTENTIONAL_OVERLOAD", "OFF_GRID_UNINTENTIONAL_WAIT_FOR_USER_MANUAL_BACKUP", "OFF_GRID_UNINTENTIONAL_WAIT_FOR_USER_LOW_SOE", "OFF_GRID_UNINTENTIONAL_WAIT_FOR_USER_NO_INVERTERS_READY", "OFF_GRID_UNINTENTIONAL_WAIT_FOR_USER_RETRIES_EXHAUSTED":
			visible = true
